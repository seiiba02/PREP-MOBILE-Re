...
import { DISTRICT_2_BARANGAYS } from '../../../src/constants/barangays';
            ...
            >
                ...
                <View style={sharedStyles.whiteContainer}>
                    ...
                    <View style={styles.titleContainer}>
                        ...
                        <Text style={[sharedStyles.sectionTitle, { marginBottom: 0 }]}>San Juan District 2</Text>
                    </View>

                    <View style={styles.listContainer}>
                        {DISTRICT_2_BARANGAYS.map((barangay) => (
